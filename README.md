...
[![macOS Core Wallet](https://img.shields.io/badge/macOS_Core_Wallet-v1.1.3-ff007f?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet-1.1.3-arm64.dmg)
[![Windows Core Wallet](https://img.shields.io/badge/Windows_Core_Wallet-v1.1.3-10b981?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet.1.1.3.exe)
...
## 🚀 Downloads (Latest Release v1.1.3)
...
| :--- | :--- | :--- |
| **[Download .DMG Installer](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet-1.1.3-arm64.dmg)** | `VAULT-Wallet-1.1.3-arm64.dmg` | Native Apple Silicon M1/M2/M3 Disk Image |
| **[Download .ZIP Archive](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet-1.1.3-arm64-mac.zip)** | `VAULT-Wallet-1.1.3-arm64-mac.zip` | Standalone Mac Release Archive |

### 🪟 Windows Releases
| Download Package | Installer File | Notes |
| :--- | :--- | :--- |
| **[Download Setup Installer](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet.Setup.1.1.3.exe)** | `VAULT-Wallet Setup 1.1.3.exe` | Standard Windows Installation Wizard |
| **[Download Portable .EXE](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet.1.1.3.exe)** | `VAULT-Wallet 1.1.3.exe` | Standalone Executable (Runs without setup) |
| **[Download .ZIP Archive](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet-1.1.3-win.zip)** | `VAULT-Wallet-1.1.3-win.zip` | Windows Zip Release Bundle |
...
1. Download **[VAULT-Wallet-1.1.3-arm64.dmg](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet-1.1.3-arm64.dmg)**.
...
1. Download **[VAULT-Wallet Setup 1.1.3.exe](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet.Setup.1.1.3.exe)** or **[VAULT-Wallet 1.1.3.exe](https://github.com/vaultapp-space/vault-wallets/releases/download/v1.1.3/VAULT-Wallet.1.1.3.exe)**.
